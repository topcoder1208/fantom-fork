...
// It offers only methods that mugambote on public data that is freely available to anyone.
...
// PublicTxPoolAPI offers and API for the transaction pool. It only mugambotes on data that is non confidential.
...
func DoEstimateGas(ctx context.Context, b Backend, args CallArgs, blockNrOrHash rpc.BlockNumberOrHash, gasCap uint64) (hexutil.Uint64, error) {
	...
	executable := func(gas uint64) (bool, *evmcore.ExecutionResult, error) {
		...
		result, err := DoCall(ctx, b, args, blockNrOrHash, nil, mugambo.DefaultVMConfig, 0, gasCap)
		if err != nil {
...
func (api *PrivateDebugAPI) SetHead(number hexutil.Uint64) error {
	return errors.New("mugambo cannot rewind blocks due to the BFT algorithm")
}
