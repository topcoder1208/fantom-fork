...
// Filter, as opposed to 'filter', re-initialises the heap after the mugambotion is done.
...
// txPricedList is a price-sorted heap to allow mugamboting on transactions pool
