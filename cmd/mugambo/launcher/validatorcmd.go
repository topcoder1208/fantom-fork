...
between mugambo nodes by simply copying.
...
func validatorKeyCreate(ctx *cli.Context) error {
	...
	fmt.Printf("- You must BACKUP your key file! Without the key, it's impossible to mugambote the validator!\n")
