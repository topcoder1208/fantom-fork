...
import (
	...
	"github.com/topcoder1208/fantom-fork/cmd/cmdtest"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "mugambo-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "mugambo-test" in exec().
	reexec.Register("mugambo-test", func() {
...
func exec(t *testing.T, args ...string) *testcli {
	...
	// Boot "mugambo". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("mugambo-test", args...)
