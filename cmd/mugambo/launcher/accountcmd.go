...
var (
	walletCommand = cli.Command{
		...
		Description: `
    mugambo wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	mugambo wallet [options] /path/to/my/presale.wallet
...
`,
			},
			{
				...
				Description: `
    mugambo account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    mugambo account update [options] <address>
...
`,
			},
			{
				...
				ArgsUsage: "<keyFile>",
				Description: `
    mugambo account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    mugambo account import [options] <keyfile>
