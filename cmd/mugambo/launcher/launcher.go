...
var (
	...
	app = flags.NewApp(gitCommit, gitDate, "the go-mugambo command line interface")
...
func initFlags() {
	...
	nodeFlags = append(nodeFlags, mugamboFlags...)
...
// mugambo is the main entry point into the system if no special subcommand is ran.
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	// Create a client to interact with local mugambo node.
