...
import (
	...
	"github.com/topcoder1208/fantom-fork/gossip/blockproc/drivermodule"
	"github.com/topcoder1208/fantom-fork/gossip/blockproc/eventmodule"
	"github.com/topcoder1208/fantom-fork/gossip/blockproc/evmmodule"
	"github.com/topcoder1208/fantom-fork/gossip/blockproc/sealmodule"
...
func DefaultBlockProc(g mugambo.Genesis) BlockProc {
	return BlockProc{
...
func NewService(stack *node.Node, config Config, store *Store, signer valkeystore.SignerI, blockProc BlockProc, engine mugambobft.Consensus, dagIndexer *vecmt.Index) (*Service, error) {
...
func newService(config Config, store *Store, signer valkeystore.SignerI, blockProc BlockProc, engine mugambobft.Consensus, dagIndexer *vecmt.Index) (*Service, error) {
	svc := &Service{
		config:             config,
...
// MakeProtocols constructs the P2P protocol definitions for `mugambo`.
