...
import (
	...
	"github.com/topcoder1208/fantom-fork/mugambo/genesis/driver/drivercall"
	...
	netinitcall "github.com/topcoder1208/fantom-fork/mugambo/genesis/netinit/netinitcalls"
...
func NewDriverTxGenesisTransactor(g mugambo.Genesis) *DriverTxGenesisTransactor {
...
func (p *DriverTxListener) OnNewLog(l *types.Log) {
	...
	if l.Topics[0] == driverpos.Topics.UpdateNetworkRules && len(l.Data) >= 64 {
		...
		p.bs.DirtyRules, err = mugambo.UpdateRules(p.bs.DirtyRules, diff)
		if err != nil {
