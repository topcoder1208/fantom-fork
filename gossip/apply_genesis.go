...
func (s *Store) ApplyGenesis(blockProc BlockProc, g mugambo.Genesis) (genesisHash hash.Hash, err error) {
...
func (s *Store) applyEpoch0Genesis(g mugambo.Genesis) (evmBlock *evmcore.EvmBlock, err error) {
	...
	s.SetBlockEpochState(blockproc.BlockState{
		...
		EpochGas:              0,
		EpochCheaters:         mugambobft.Cheaters{},
...
func (s *Store) applyEpoch1Genesis(blockProc BlockProc, g mugambo.Genesis) (err error) {
	...
	prettyHash := func(root common.Hash, g mugambo.Genesis) hash.Event {
