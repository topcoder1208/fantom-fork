...
func (t TestBackend) GetRules() mugambo.Rules {
	return t.rules
}

func (t TestBackend) GetPendingRules() mugambo.Rules {
...
func TestSuggestPrice(t *testing.T) {
	backend := &TestBackend{
		block:             1,
		totalGasPowerLeft: 0,
		rules:             mugambo.FakeNetRules(),
		pendingRules:      mugambo.FakeNetRules(),
	}
