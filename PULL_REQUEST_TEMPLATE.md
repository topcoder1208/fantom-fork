Please check if what you want to add to `go-mugambo` list meets [quality standards](https://github.com/MugamboBC/go-mugambo/blob/master/CONTRIBUTING.md#quality-standard) before sending pull request.
