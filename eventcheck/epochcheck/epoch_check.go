...
type Reader interface {
	base.Reader
	GetEpochRules() (mugambo.Rules, idx.Epoch)
}
...
func CalcGasPowerUsed(e inter.EventPayloadI, rules mugambo.Rules) uint64 {
	txsGas := uint64(0)
...
func (v *Checker) checkGas(e inter.EventPayloadI, rules mugambo.Rules) error {
...
func CheckTxs(txs types.Transactions, rules mugambo.Rules) error {
	maxType := uint8(0)
